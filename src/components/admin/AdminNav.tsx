...
const TABS = [
  ...
  { href: '/admin/payouts', labelKey: 'navFailedPayouts' },
...
export default function AdminNav() {
  ...
  return (
    <nav className="flex gap-2 mb-6 border-b border-border dark:border-[#253634] overflow-x-auto">
      {TABS.map(tab => {
        ...
        return (
          <Link
            key={tab.href}
            href={tab.href}
            className={`shrink-0 whitespace-nowrap px-3 py-2 text-body font-medium border-b-2 transition-colors ${
              active
