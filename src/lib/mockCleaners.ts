...
export const MOCK_REVIEWS: MockReview[] = [
  ...
  {
    id: 'mock-r1', cleaner_slug: 'maria-stavrou', reviewer_name: 'Eleni Papadaki',
  ...
  {
    id: 'mock-r2', cleaner_slug: 'maria-stavrou', reviewer_name: "James O'Connor",
  ...
  {
    id: 'mock-r3', cleaner_slug: 'maria-stavrou', reviewer_name: 'Anastasia Kyriakou',
  ...
  {
    id: 'mock-r4', cleaner_slug: 'andreas-petrou', reviewer_name: 'Sarah Mitchell',
  ...
  {
    id: 'mock-r5', cleaner_slug: 'andreas-petrou', reviewer_name: 'Nikos Andreou',
    rating: 5, date: 'March 2025',
  ...
  {
    id: 'mock-r6', cleaner_slug: 'elena-georgiou', reviewer_name: 'Katerina Stavrou',
  ...
  {
    id: 'mock-r7', cleaner_slug: 'elena-georgiou', reviewer_name: 'Mark Thompson',
  ...
  {
    id: 'mock-r8', cleaner_slug: 'natasha-ivanova', reviewer_name: 'Olga Sorokina',
    rating: 5, date: 'April 2025',
  ...
  {
    id: 'mock-r9', cleaner_slug: 'natasha-ivanova', reviewer_name: 'Stavros Petrides',
  ...
  {
    id: 'mock-r10', cleaner_slug: 'christos-kyriacou', reviewer_name: 'Ioanna Ioannou',
    rating: 5, date: 'May 2025',
  ...
  {
    id: 'mock-r11', cleaner_slug: 'christos-kyriacou', reviewer_name: 'David Chen',
    rating: 5, date: 'April 2025',
  ...
  {
    id: 'mock-r12', cleaner_slug: 'sofia-papadopoulou', reviewer_name: 'Yianna Nikolaou',
    rating: 4, date: 'March 2025',
    body: "Sofia is lovely and does a thorough job. Great for holiday rentals in the area. Will rebook.",
  },
  {
    id: 'mock-r13', cleaner_slug: 'sofia-papadopoulou', reviewer_name: 'Tom Bradley',
