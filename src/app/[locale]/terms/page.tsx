  ...
  return (
    ...
    <div className="min-h-screen bg-[#F7FAF9] px-4 sm:px-10 py-10 sm:py-14">
      <div className="max-w-[760px] mx-auto">
        <h1 className="text-[28px] sm:text-[32px] font-medium text-[#0D1F1E] mb-2">Terms of Service</h1>
        ...
        <Section title="2. Cyprus Cleaners is a marketplace, not a cleaning company">
          ...
          <p>
            <strong className="text-[#0D1F1E]">This means:</strong> Cleaners are solely responsible for the quality,
        ...
        <Section title="4. Bookings and payment" id="payments">
          ...
          <ul className="list-disc pl-5 space-y-1.5">
            <li><strong className="text-[#0D1F1E]">Requesting</strong> — a Customer requests a booking with a saved payment card. The card is authorised but <strong className="text-[#0D1F1E]">not charged</strong> at this point. The Cleaner has 24 hours to confirm or decline.</li>
            <li><strong className="text-[#0D1F1E]">Confirming</strong> — if the Cleaner confirms, the Customer&rsquo;s card is charged in full at that moment, at the rate quoted when the booking was requested. This is when payment actually happens — not at completion.</li>
            <li><strong className="text-[#0D1F1E]">Declining or no response</strong> — if the Cleaner declines, or doesn&rsquo;t respond within 24 hours, the booking is cancelled automatically and the Customer is never charged.</li>
            <li><strong className="text-[#0D1F1E]">Completing</strong> — the Cleaner marks the job complete once the scheduled date has arrived and photo evidence of the completed work has been uploaded.</li>
          </ul>
          <p>
        ...
        <Section title="5. Cancellation policy" id="cancellation">
          <p>
            Either Customer or Cleaner can cancel a <strong className="text-[#0D1F1E]">requested</strong> or{' '}
            <strong className="text-[#0D1F1E]">confirmed</strong> booking before it takes place.
          </p>
          <ul className="list-disc pl-5 space-y-1.5">
            <li><strong className="text-[#0D1F1E]">Cancelling 24 hours or more before the scheduled start time</strong> — if the Customer was already charged, they receive a full refund.</li>
            <li><strong className="text-[#0D1F1E]">Cancelling less than 24 hours before the scheduled start time</strong> — no refund is issued. This is a binary cut-off, not a prorated/sliding scale.</li>
        ...
        <Section title="6. Disputes and quality issues" id="disputes">
          <p>
            ...
            <strong className="text-[#0D1F1E]">7 days</strong> of the booking being marked complete. The Cleaner gets
            a chance to respond, and an administrator reviews both sides (including the completion photos) and rules
            within an internal <strong className="text-[#0D1F1E]">5-day service-level target</strong>. Possible
